        ...
        <form @submit.prevent="submitForm" class="space-y-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:col-span-2">
                    ...
                    <!-- Điểm uy tín -->
                    <div v-if="user.role !== 'admin'" :class="user.trust_score < 70 ? 'bg-red-50/30 border-red-100/50' : 'bg-amber-50/30 border-amber-100/50'" class="border rounded-2xl p-5 flex items-start gap-4 shadow-sm sm:col-span-2 md:col-span-1">
